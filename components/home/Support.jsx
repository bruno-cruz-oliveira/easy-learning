            ...
            <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center space-y-12 md:space-y-0 md:space-x-8'>
                <div className='flex-1'>
                    ...
                    <p className='text-black leading-relaxed mb-8 mt-8'>
                        ...
                        My Life's mission is to help novice and professional software engineers
                        Increase their skills, make more money, and ultimately change their lives for the better
                    </p>
